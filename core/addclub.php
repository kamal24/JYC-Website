        ...
        if ((($_FILES["file1"]["type"] == "image/gif")
            ...
            if ($_FILES["file1"]["error"] > 0){
                ...
                else
                {
                   ...
                   $query = "INSERT INTO `$dbname`.`club` (`id`,`clubname`,`image_name1`,`image_name2`,`image_name3`,`image_name4`,`image_name5`,
                    `bgimage`,`description`)  VALUES (null,'$clubname','$fileName[0]',
                    '$fileName[1]','$fileName[2]','$fileName[3]','$fileName[4]','$fileName[5]','$desc')";
